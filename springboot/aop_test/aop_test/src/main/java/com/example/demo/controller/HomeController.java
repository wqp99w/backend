 ...
 */
// 롬복의 로그 처리 -> log.xxx() 이후로는 Sysout은 서버 부하걸리니까 사용 x
@Slf4j
@Controller
public class HomeController {
	...
	public String home(
			...
			//		인증키, 시크릿키 등 별도의 중요 정보들도 헤더를 직접 추출 가능!!
		...
		// IP 트래킹 가능 (자기 자신은 0.0.0.0 ...)

		// proxy -> IP를 우회하여 접근할 때 사용 (1회성, 여러번 거쳐서 접속 가능..)
		...
		// 특정 비즈니스 로직
		// targetService.runTask 이 메소드 (가정, 특정 비즈니스 로직에 aop 이용)
